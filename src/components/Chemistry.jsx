...
import { videoData, chemistryChapters } from "../constants";
    ...
    <div>
      ...
      <div className="bg-[#F3F8FF] text-center flex flex-col justify-center items-center py-24">
        <div className="w-[878px] flex flex-col items-center justify-center">
          <h1 className="text-6xl font-semibold">
            Nepal Best <span className="text-[#719BDD]">Chemistry</span> Courses
          </h1>
      ...
      <div className="px-24 py-16 bg-[#FEF5E6]">
        <div className="grid grid-cols-3 gap-8 mb-8">
          {chemistryChapters
            .slice(0, showAllChapters ? chemistryChapters.length : itemsPerRow) // Show all or limited chapters
            .map((item) => (
